...
def is_obscene(text):
    words = pd.read_csv('data/мат.txt').values.flatten()
    phrase = text.lower()
    ...
    for word in words:
        for part in range(len(phrase)):
            ...
            if distance(fragment, word) <= len(word)*0.15:
                ...
                # bot.send_message(message.chat.id, "Дружище, [{} {}](tg://user?id={}), твоё сообщение было удалено из-за содержания в нём запрещённых слов! "
